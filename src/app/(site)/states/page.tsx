...
import { fetchAllDirectoryStates } from "@/lib/directory/data";
...
export const metadata: Metadata = {
  ...
  description:
    "Browse every state directory of local businesses without their own website — grouped by city with ratings, phones, and Maps links.",
...
export default async function StatesIndexPage() {
  ...
  try {
    states = await fetchAllDirectoryStates();
  } catch (e) {
