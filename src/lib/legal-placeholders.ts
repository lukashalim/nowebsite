...
export const COMPLIANCE_SMS_DISCLOSURE =
  "SMS Updates: By providing your phone number to Suite300 LLC, you agree to receive project-related SMS updates. Message frequency varies. Reply HELP for assistance or STOP to opt out. Message and data rates may apply.";
...
export const RING_READY_COMPLIANCE_DISCLOSURE =
  "By submitting this form, you agree to receive recurring project-related SMS updates from Suite300 LLC. Message frequency varies. Message and data rates may apply. Reply HELP for help, STOP to opt out. Mobile information will not be shared with third parties for marketing or promotional purposes.";

export const RING_READY_COMPLIANCE_CHECKBOX_TEXT =
  "I agree to receive recurring project-related SMS updates from Suite300 LLC. Message frequency varies. Message and data rates may apply. Reply HELP for help, STOP to opt-out.";

export const RING_READY_COMPLIANCE_URL =
  "https://www.ringreadysite.com/compliance";

export const RING_READY_COMPLIANCE_CONSENT_VERSION = "2026-06-compliance-page-v2";
