...
# New: one-time $9 Price ID from Stripe Dashboard (Products → Add product → One time $9)
STRIPE_BUY_FULL_LIST_PRICE_ID=price_...
```

Keep `STRIPE_PRICE_ID` for the Pro subscription unchanged.
